...
<body>
    ...
    <div class="bg-gray-100 shadow-sm px-8 py-3 flex flex-wrap justify-between items-center">
        ...
        <div class="flex flex-wrap gap-4 items-center w-full md:w-max">
            <a href="./pages/cart.php" class="font-medium hover:underline flex items-center gap-2">Cart <span class="inline-block h-6 w-6 rounded-full bg-zinc-800 text-white text-center"><?= $countItems ?></span> </a>
